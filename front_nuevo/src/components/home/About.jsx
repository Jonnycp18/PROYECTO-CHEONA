        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-neutral-700 mb-4 text-center lg:text-left">
              En el corazón de la naturaleza, Finca Cheona es un refugio donde
              el tiempo parece detenerse. Un lugar para reconectar con lo
              esencial, disfrutar de la tranquilidad y vivir experiencias
              auténticas.
            </p>

            <p className="text-neutral-600 mb-6 text-center lg:text-left">
              Nuestra finca, con su casa principal y dos acogedoras cabañas, ha
              sido cuidadosamente restaurada para ofrecer todas las comodidades
              modernas sin perder su encanto rústico. Rodeados de naturaleza y
              montañas, te invitamos a descubrir un estilo de vida donde la
              sostenibilidad y el respeto por el entorno son nuestra prioridad.
            </p>
