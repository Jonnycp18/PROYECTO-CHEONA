  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Nuestra estancia en la finca fue mágica. La tranquilidad, el contacto con la naturaleza y las instalaciones superaron nuestras expectativas.",
      avatar:
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Lugar ideal para desconectar. La cabaña es acogedora y la chimenea le da un toque especial en las noches frías.",
      avatar:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Celebramos el cumpleaños de mi esposo y fue perfecto. Los niños disfrutaron del espacio al aire libre y nosotros de la tranquilidad.",
      avatar:
