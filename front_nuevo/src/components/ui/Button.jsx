...
const Button = ({
  ...
  const variantClasses = {
    primary:
      "bg-primary text-white hover:bg-primary-dark active:bg-primary-darker disabled:bg-primary/50",
    secondary:
      "bg-secondary text-white hover:bg-secondary-dark active:bg-secondary-darker disabled:bg-secondary/50",
    outline:
